...
const locale$2 = { "data-validation": {
  operators: {
    between: "między",
...
const locale$1 = { "sheets-data-validation": {
  operators: {
    between: "między",
    greaterThan: "większe niż",
    greaterThanOrEqual: "większe lub równe",
...
const locale = { "sheets-data-validation-ui": {
  ...
  textLength: { title: "Długość tekstu" },
  decimal: { title: "Liczba" },
  whole: { title: "Liczba całkowita" },
  checkbox: {
    title: "Pole wyboru",
  ...
  showTime: { label: "Pokaż selektor czasu" },
